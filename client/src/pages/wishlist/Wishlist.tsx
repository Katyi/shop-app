      ...
      <main className="flex-grow:1 p-4 md:p-10 w-full">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
          ...
          <div className="hidden lg:flex gap-4 text-sm uppercase">
            ...
            >
              {t('wishlist.shoppingBag')} ({user ? totalCartItems : 0})
            </span>
            <span className="border-b">
              {t('wishlist.wishlist')} ({user ? totalWishlistItems : 0})
            </span>
          </div>
        </div>
        ...
        {!user && (
          <div className="flex flex-col">
            <div className="text-center py-20 uppercase border-b border-gray-300">
              <p className="text-gray-400">{t('wishlist.notAuthorized')}</p>
              <button
                className="w-full max-w-[500px] h-[55px] bg-black text-white uppercase cursor-pointer mt-12 mb-20"
